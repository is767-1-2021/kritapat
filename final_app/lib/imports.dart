...
const buttonsBackgroundColor = Color(0xFF263238);
const backgroundColor = Color(0xFF455A64);
const yellowColor = Colors.amber;
          ...
          child: isEqualSign
              ...
              : Text(
                  ...
                  style: textStyle?.copyWith(
                      color: isColored ? whiteColor : whiteColor),
                ),
        ),
      ),
    );
